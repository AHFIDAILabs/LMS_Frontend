      ...
      <div className="flex-1 lg:ml-64 overflow-y-auto">
        <div className="max-w-[1600px] mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
            <div className="bg-slate-800/50 backdrop-blur rounded-xl border border-gray-700 p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <p className="text-gray-400 text-xs sm:text-sm mb-1 truncate">Total Students</p>
                  <p className="text-2xl sm:text-3xl font-bold text-white">{totalStudents}</p>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-blue-500/20 flex items-center justify-center shrink-0 ml-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur rounded-xl border border-gray-700 p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <p className="text-gray-400 text-xs sm:text-sm mb-1 truncate">Active</p>
                  <p className="text-2xl sm:text-3xl font-bold text-white">
                    {stats.activeStudents}
                  </p>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-green-500/20 flex items-center justify-center shrink-0 ml-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur rounded-xl border border-gray-700 p-4 sm:p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-emerald-500/20 flex items-center justify-center shrink-0 ml-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur rounded-xl border border-gray-700 p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <p className="text-gray-400 text-xs sm:text-sm mb-1 truncate">Avg Progress</p>
                  <p className="text-2xl sm:text-3xl font-bold text-white">
                    {stats.averageProgress}%
                  </p>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-purple-500/20 flex items-center justify-center shrink-0 ml-2">
                    ...
                    <div className="mb-3">
                      <div className="flex items-center justify-between text-xs mb-1.5">
                        <span className="text-gray-400">
                          {student.progress?.completedLessons || 0}/
                          {student.progress?.totalLessons || 0} lessons
                        </span>
