      ...
      <div className="relative">
        ...
        <input
          ...
          className={clsx(
            ...
            Icon ? 'pl-10' : 'pl-4',
            suffix ? 'pr-12' : 'pr-4',
            readOnly ? 'opacity-50 cursor-not-allowed' : `focus:border-lime-500/50 focus:ring-2 ring-lime-500/30`,
          )}
        />
    ...
    <div className="flex items-center justify-between py-4 border-b border-gray-800/60 last:border-0">
      ...
      <button
        ...
        className={clsx(
          ...
          checked ? 'bg-lime-500' : 'bg-slate-700'
        )}
      >
        <span className={clsx(
    ...
    <div className="flex items-center justify-between pt-6 border-t border-gray-800/60">
      ...
      <button
        ...
        className={clsx(
          ...
          'bg-lime-500 hover:bg-lime-600 text-white shadow-lg disabled:opacity-50 disabled:cursor-not-allowed'
        )}
      >
              ...
              {tabs.map((t) => (
                <button
                  ...
                  className={clsx(
                    ...
                    tab === t.id
                      ? `bg-lime-500/10 text-lime-400 border-lime-500/20 border`
              ...
              <div className="bg-slate-900 border border-gray-800/60 rounded-2xl p-6 space-y-8">
                ...
                <div className="flex items-center gap-5">
                  <div className="relative group shrink-0">
                    <div className="w-20 h-20 rounded-2xl overflow-hidden bg-gradient-to-br from-lime-500 to-lime-600 flex items-center justify-center text-white text-2xl font-bold">
                      {avatarSrc
                  ...
                  <div>
                    ...
                    <button
                      onClick={() => fileRef.current?.click()}
                      className="mt-2 text-xs text-lime-400 hover:underline font-medium"
                    >
                      Change photo
                    </button>
                  </div>
              ...
              <div className="space-y-5">
                      ...
                      <div className="flex gap-1">
                        {[8, 12, 16, 20].map(n => (
                          <div key={n} className={clsx(
                            ...
                            newPwd.length >= n ? 'bg-lime-500' : 'bg-slate-700'
                          )} />
                        ))}
                      </div>
                ...
                <div className="bg-slate-900 border border-gray-800/60 rounded-2xl p-6">
                  <div className="flex items-start gap-4">
                    <div className="p-2.5 rounded-xl bg-lime-500/10 border-lime-500/20 border shrink-0">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="flex items-center justify-between py-3 border-b border-gray-800/60 last:border-0">
                        ...
                        {s.current
                          ? <span className="text-xs px-2 py-1 rounded-full bg-lime-500/15 text-lime-400 font-semibold">This device</span>
