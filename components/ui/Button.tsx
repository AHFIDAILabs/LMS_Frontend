...
export function Button({
  ...
  const variants = {
    primary: 'bg-primary text-dark-900 hover:bg-primary-light shadow-lg hover:shadow-glow-green',
    secondary: 'bg-transparent text-white border border-gray-700 hover:border-primary hover:text-primary',
